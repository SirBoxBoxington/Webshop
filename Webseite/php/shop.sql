...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 09. Jun 2018 um 03:52
...
INSERT INTO `user` (`Username`, `PW`, `Anrede`, `Vorname`, `Nachname`, `email`, `PLZ`, `Ort`, `Adresse`, `IsAdmin`, `IsLdap`) VALUES
('gt', '202cb962ac59075b964b07152d234b70', 'Fr', 'Gl', 'e@a.at', 'Mr', 2545, 'Wo', 'StraÃŸe', 0, 0);
...
--
ALTER TABLE `produkte`
  MODIFY `ProduktID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
